...
- for each platform build a linear model (in the following we use the `stats::lm` function) and map platform the RT space of the corresponding platform into reference platform RT space (by using the `stats::predict.lm` method)
