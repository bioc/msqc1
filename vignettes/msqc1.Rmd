...
Here we provide a experiment data package containing all the spreadsheets used for figures and supplemental figures for the following publication.
...
The spreadsheets were extracted out of the [mass spectrometric measurements](https://panoramaweb.org/labkey/search/home/search.view?q=Kockmann) by using the [skyline](https://skyline.gs.washington.edu) software version 3,1 and the following [template]() (t.b.d).
