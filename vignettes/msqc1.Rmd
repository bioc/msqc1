...
Here we provide an experiment data package containing all the spread sheets used for figures and supplemental figures for the following publication.
...
Raw instrument data is accessible for registered users through [http://fgcz-bfabric.uzh.ch](http://fgcz-bfabric.uzh.ch/bfabric) as project 1959.
Raw LC-MS data from all five platforms were imported into 
[Skyline 3.1](https://skyline.gs.washington.edu), processed, and are available though 
