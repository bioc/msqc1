...
%\VignetteIndexEntry{msqc1 - a mass spec data set for targeted proteomics performance evaluated}
-->
...
library(msqc1)
```
# msqc1 - a mass spectrometer data set for targeted proteomics performance
...
```{r "Supplement_figure9", echo=FALSE, fig.width=14, fig.height=9, fig.retina=3, warning=FALSE}
msqc1:::.supplement_figure9(data=msqc1_8rep)
```
