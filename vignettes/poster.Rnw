...
\resizebox{.9\textwidth}{!}{\hspace{3.5cm} Tobias Kockmann$^\diamond$, Christian Trachsel$^\diamond$, Christian Panse$^\diamond$, {\AA}sa W{\aa}hlander$^\ddag$, Nathalie Selevsek$^\diamond$, Jonas Grossmann$^\diamond$, Witold E. Wolski$^\diamond$, \underline{Claudia Fortes}$^\diamond$, \underline{Paolo Nanni}$^\diamond$ and Ralph Schlapbach$^\diamond$}\\[1.0cm]
}
...
<<figure3, eval=TRUE, echo=FALSE, fig=TRUE, include=FALSE, width=4.0, height=4.0>>=
...
<<figure6,eval=TRUE, echo=FALSE, fig=TRUE, include=FALSE, width=7.0, height=7.0>>=
